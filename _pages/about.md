...
I am a Ph.D. researcher in Educational Psychology at the **USC Rossier School of Education**, affiliated with the [USC Center for Generative AI & Society](https://aigensociety.usc.edu/). My research examines how people learn with and from AI, with particular attention to AI literacy development, equitable access to AI tools in educational settings, and the behavioral and motivational patterns that shape learner engagement with generative technologies.
...
**Xiu, L. (2025).** Research on the design of modern distance education system based on agent technology. *Pinnacle Academic Press Proceedings Series, 2,* 160–169.

**Xiu, L. (2025, March).** Analyses of online learning behaviour based on linear regression algorithm. *2025 IEEE International Conference on Electronics, Energy Systems and Power Engineering (EESPE),* 1333–1338.

**Xiu, L. (2024).** Integration innovation of big data analysis and artificial intelligence in the field of education. *International Journal of Social Sciences and Public Administration, 5*(2), 175–182. [https://doi.org/10.62051/ijsspa.v5n2.21](https://doi.org/10.62051/ijsspa.v5n2.21)

**Xiu, L. (2024).** The challenges and approaches of generative artificial intelligence (GenAI) to promote educational innovation. *International Journal of Computer Science and Information Technology, 4*(3), 400–407. [https://doi.org/10.62051/ijcsit.v4n3.45](https://doi.org/10.62051/ijcsit.v4n3.45)

**Xiu, L. (2024).** *Exploring the approaches to learning of bilingual students in online upper elementary mathematics classes: A mixed-methods investigation* (Publication No. 31329773) [M.A. thesis, University of California, Los Angeles]. ProQuest Dissertations & Theses Global.
